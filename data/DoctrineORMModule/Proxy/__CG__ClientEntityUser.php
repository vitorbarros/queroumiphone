...
class User extends \Client\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Client\\Entity\\User' . "\0" . 'userId', '' . "\0" . 'Client\\Entity\\User' . "\0" . 'userUsername', '' . "\0" . 'Client\\Entity\\User' . "\0" . 'userPassword', '' . "\0" . 'Client\\Entity\\User' . "\0" . 'userSalt', '' . "\0" . 'Client\\Entity\\User' . "\0" . 'userCreatedAt', '' . "\0" . 'Client\\Entity\\User' . "\0" . 'userUpdatedAt'];
        }
